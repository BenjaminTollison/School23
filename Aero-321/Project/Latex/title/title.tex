...
%----------------------------------------------------------------------------------------
\centering
\includegraphics[width=8cm]{title/fun-logo.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\emph{Tasks} \\
\text{Author} \\[1.2em] 
\text{Tables 1,2} \\[1.2em] 
\text{Tables 1,3} \\[1.2em] 
\text{Tables 3,4}\\[1.2em] 
\end{flushright}
\end{minipage}\\[2cm]
\makeatother
